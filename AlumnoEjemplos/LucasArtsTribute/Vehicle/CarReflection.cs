...
namespace AlumnoEjemplos.LucasArtsTribute
{
    public class CarReflection
    {
        ...
        private void ConfigReflection()
        {
            ...
            {
                GuiController.Instance.Modifiers.addVertex3f("LightPosition", new Vector3(-300, -300, -300),
                                                             new Vector3(300, 1500, 300), new Vector3(100, 700, 100));
        ...
        private void SetValuesToMesh()
        {
            ...
            try
            {
                _car.body.Effect.SetValue("lightColor",
                ...
                _car.body.Effect.SetValue("lightAttenuation",
